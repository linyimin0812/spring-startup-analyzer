...
1. Click [realease](https://github.com/linyimin0812/spring-startup-analyzer/releases/download/v2.0.6/spring-startup-analyzer.tar.gz) to download the latest version tar.gz package
