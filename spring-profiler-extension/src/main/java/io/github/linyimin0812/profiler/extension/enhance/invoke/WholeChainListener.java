...
public class WholeChainListener implements EventListener {
    ...
    public void start() {
        ...
        if (ProfilerSettings.contains("spring-startup-analyzer.invoke.chain.packages")) {

            String packages = ProfilerSettings.getProperty("spring-startup-analyzer.invoke.chain.packages", "");
